...
echo 'add a remote pseudo for the adr-3-0 repository'

git remote add origin https://complexmathguy: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@github.com/complexmathguy/adr-3-0
